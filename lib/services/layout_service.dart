...
class LayoutService {
  static const String _keyDashboardLayoutLandscape = 'dashboard_layout_landscape';
  ...
  static Future<void> saveLayout(DashboardLayout layout, {bool isPortrait = false}) async {
    final prefs = await SharedPreferences.getInstance();
    final key = isPortrait ? _keyDashboardLayoutPortrait : _keyDashboardLayoutLandscape;
